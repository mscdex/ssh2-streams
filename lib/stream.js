...
var consts = require('./constants'),
    keyParse = require('./keyParser'),
    utils = require('./utils'),
    isStreamCipher = utils.isStreamCipher,
    isGCM = utils.isGCM,
    iv_inc = utils.iv_inc,
    decryptKey = utils.decryptKey,
    genPublicKey = utils.genPublicKey,
    readString = utils.readString;
...
function SSH2Stream(cfg) {
  ...
  if (this.server
    ...
    privKeyInfo = keyParse(cfg.privateKey);
