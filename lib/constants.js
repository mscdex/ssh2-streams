...
if (process.versions.openssl >= '1.0.1' && process.version >= 'v0.11.12') {
...
if (process.version >= 'v0.11.14') {
  ...
  KEX = [
    'ecdh-sha2-nistp256', // REQUIRED curve
    'ecdh-sha2-nistp384', // REQUIRED curve
    'ecdh-sha2-nistp521'  // REQUIRED curve
  ].concat(KEX);
}
...
if (process.version >= 'v0.11.14')
  SERVER_HOST_KEY.splice(1, 0, 'ecdsa-sha2-nistp256');
...
COMPRESS = [
  'none',             // REQUIRED
  'zlib@openssh.com', // OPTIONAL   ZLIB (LZ77) compression, except
                      //            compression/decompression does not start
                      //            until after successful user
                      //            authentication
