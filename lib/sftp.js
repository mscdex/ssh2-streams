...
var MAX_PKT_LEN = 34000,
    MAX_REQID = Math.pow(2, 32) - 1,
    CLIENT_VERSION_BUFFER = new Buffer([0, 0, 0, 5 /* length */,
                                        REQUEST.INIT,
                                        0, 0, 0, 3 /* version */]),
    SERVER_VERSION_BUFFER = new Buffer([0, 0, 0, 5 /* length */,
                                        RESPONSE.VERSION,
                                        0, 0, 0, 3 /* version */]),
    /*
...
SFTPStream.prototype._transform = function(chunk, encoding, callback) {
  var state = this._state,
      server = this.server,
      status = state.status,
      pktType = state.pktType,
      pktBuf = state.pktBuf,
      pktLeft = state.pktLeft,
      version = state.version,
      pktHdrBuf = state.pktHdrBuf,
  ...
  while (true) {
    if (status === 'discard') {
      ...
      chunkLeft = (chunkLen - chunkPos);
      if (pktLeft <= chunkLeft) {
        chunk.copy(pktBuf, pktBuf.length - pktLeft, chunkPos, chunkPos + pktLeft);
        chunkPos += pktLeft;
        pktLeft = 0;
        buffer = pktBuf;
        pktBuf = undefined;
      ...
      if (pktType === RESPONSE.VERSION || pktType === REQUEST.INIT) {
        ...
        */
        ...
        /*
          All other packets (client and server) begin with a (client) request id:
          uint32     id
        */
          ...
          if (req && cb) {
            if (pktType === RESPONSE.STATUS) {
              ...
              */
              ...
              if (msg === false)
                return;
              var lang = readString(buffer, buffer._pos, 'ascii', this, callback);
              if (lang === false)
                return;
              ...
              */
              ...
              for (var i = 0; i < namesLen; ++i) {
                ...
                // filenames
                filename = readString(buffer, buffer._pos, 'utf8', this, callback);
                if (filename === false)
                  return;
...
SFTPStream.prototype.open = function(path, flags, attrs, cb) {
  if (this.server)
    throw new Error('Client-only method called in server mode');
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing OPEN');
...
SFTPStream.prototype.close = function(handle, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing CLOSE');
  return this.push(buf);
};
SFTPStream.prototype.readData = function(handle, buf, off, len, position, cb) {
  ...
  */
  var handlelen = handle.length,
      p = 9,
      pos = position,
      out = new Buffer(4 + 1 + 4 + 4 + handlelen + 8 + 4);
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing READ');
...
SFTPStream.prototype.writeData = function(handle, buf, off, len, position, cb) {
  ...
  */
  var handlelen = handle.length,
      p = 9,
      out = new Buffer(4 + 1 + 4 + 4 + handlelen + 8 + 4 + len);
  ...
  state.requests[reqid] = {
    cb: function(err) {
      if (err)
        ...
        self.emit('progress', off, originalLen - len);
        if (overflow) {
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing WRITE');
  return this.push(out);
};
...
SFTPStream.prototype.readFile = function(path, options, callback_) {
  ...
  var size,
      buffer, // single buffer with file data
      buffers, // list for when size is unknown
      pos = 0,
      handle;
...
SFTPStream.prototype.unlink = function(filename, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing REMOVE');
  return this.push(buf);
};
SFTPStream.prototype.rename = function(oldPath, newPath, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing RENAME');
  return this.push(buf);
};
SFTPStream.prototype.mkdir = function(path, attrs, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing MKDIR');
  return this.push(buf);
};
SFTPStream.prototype.rmdir = function(path, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing RMDIR');
  return this.push(buf);
};
SFTPStream.prototype.readdir = function(where, opts, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing READDIR');
  return this.push(buf);
};
SFTPStream.prototype.fstat = function(handle, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing FSTAT');
  return this.push(buf);
};
SFTPStream.prototype.stat = function(path, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing STAT');
  return this.push(buf);
};
SFTPStream.prototype.lstat = function(path, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing LSTAT');
  return this.push(buf);
};
SFTPStream.prototype.opendir = function(path, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing OPENDIR');
  return this.push(buf);
};
SFTPStream.prototype.setstat = function(path, attrs, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing SETSTAT');
  return this.push(buf);
};
SFTPStream.prototype.fsetstat = function(handle, attrs, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing FSETSTAT');
  return this.push(buf);
};
...
SFTPStream.prototype.readlink = function(path, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing READLINK');
  return this.push(buf);
};
SFTPStream.prototype.symlink = function(targetPath, linkPath, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing SYMLINK');
  return this.push(buf);
};
SFTPStream.prototype.realpath = function(path, cb) {
  ...
  */
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing REALPATH');
  return this.push(buf);
};
// extended requests
SFTPStream.prototype.ext_openssh_rename = function(oldPath, newPath, cb) {
  ...
  */
  var oldlen = Buffer.byteLength(oldPath),
      newlen = Buffer.byteLength(newPath),
      p = 9,
      buf = new Buffer(4 + 1 + 4 + 4 + 24 + 4 + oldlen + 4 + newlen);
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing posix-rename@openssh.com');
  return this.push(buf);
};
SFTPStream.prototype.ext_openssh_statvfs = function(path, cb) {
  ...
  */
  var pathlen = Buffer.byteLength(path),
      p = 9,
      buf = new Buffer(4 + 1 + 4 + 4 + 19 + 4 + pathlen);
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing statvfs@openssh.com');
  return this.push(buf);
};
SFTPStream.prototype.ext_openssh_fstatvfs = function(handle, cb) {
  ...
  */
  var handlelen = handle.length,
      p = 9,
      buf = new Buffer(4 + 1 + 4 + 4 + 20 + 4 + handlelen);
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing fstatvfs@openssh.com');
  return this.push(buf);
};
SFTPStream.prototype.ext_openssh_hardlink = function(oldPath, newPath, cb) {
  ...
  */
  var oldlen = Buffer.byteLength(oldPath),
      newlen = Buffer.byteLength(newPath),
      p = 9,
      buf = new Buffer(4 + 1 + 4 + 4 + 20 + 4 + oldlen + 4 + newlen);
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing hardlink@openssh.com');
  return this.push(buf);
};
SFTPStream.prototype.ext_openssh_fsync = function(handle, cb) {
  ...
  */
  var handlelen = handle.length,
      p = 9,
      buf = new Buffer(4 + 1 + 4 + 4 + 17 + 4 + handlelen);
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing fsync@openssh.com');
  return this.push(buf);
};
...
SFTPStream.prototype.status = function(id, code, message, lang) {
  ...
  var msgLen = Buffer.byteLength(message),
      ...
      buf = new Buffer(4 + 1 + 4 + 4 + 4 + msgLen + 4 + langLen);
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing STATUS');
  return this.push(buf);
};
SFTPStream.prototype.handle = function(id, handle) {
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing HANDLE');
  return this.push(buf);
};
SFTPStream.prototype.data = function(id, data, encoding) {
  ...
  var dataLen = (isBuffer ? data.length : Buffer.byteLength(data, encoding)),
      buf = new Buffer(4 + 1 + 4 + 4 + dataLen);
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing DATA');
  return this.push(buf);
};
SFTPStream.prototype.name = function(id, names) {
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing NAME');
  return this.push(buf);
};
SFTPStream.prototype.attrs = function(id, attrs) {
  ...
  var info = attrsToBytes(attrs),
      buf = new Buffer(4 + 1 + 4 + 4 + info.nbytes),
      p = 13;
  ...
  this.debug('DEBUG[SFTP]: Outoging: Writing ATTRS');
  return this.push(buf);
};
...
function WriteStream(sftp, path, options) {
  ...
  sftp.on('progress', function(done, left){
    self.emit('progress', done, left);
  });
