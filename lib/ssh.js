...
var MESSAGE = consts.MESSAGE,
    DYNAMIC_KEXDH_MESSAGE = consts.DYNAMIC_KEXDH_MESSAGE,
    KEXDH_MESSAGE = consts.KEXDH_MESSAGE,
...
// This is only used to send raw packets from unit tests
SSH2Stream.prototype._send = function () {
...
function parse_KEX(self, type, callback) {
  var state = self._state,
      ...
      outstate = state.outgoing,
      payload = instate.payload,
      pktType = (state.kexdh !== 'group') ? DYNAMIC_KEXDH_MESSAGE[type] :
                                            KEXDH_MESSAGE[type];
