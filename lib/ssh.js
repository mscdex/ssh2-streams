...
var pubDERToPEM = require('./keyParser').pubDERToPEM;
...
function onNEWKEYS(self) { // Client/Server
  ...
  if (inCipherInfo.authLen === 0) {
    ...
    if (!instate.hmac.bufCompute)
      instate.hmac.bufCompute = Buffer.allocUnsafe(9);
  } else {
    instate.hmac.key = undefined;
    instate.hmac.bufCompute = undefined;
  }
